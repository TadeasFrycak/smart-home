...
def get_user_list_modal():
    ...
    console.print("Opening user list modal...")
...
def get_android_modal():
    ...
    console.print("Opening Android modal...")
...
def modal_item_prepend(data):
    ...
    emit("modal_item_prepend_result", {"item": render_template("modal_edit/item_values.html", tile_id=tile_id,
...
def daterangepicker(data):
    ...
    console.print("This method is probably not working", 1)
...
def modal_item_value(data):
    ...
    console.print(
        "Change modal item value ({0}) in tile (ID: {1}) to {2} (item index is {3})".format(value_name, tile_id,
                                                                                            new_value, str(item_index)))
